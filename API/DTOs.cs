...
namespace API
{
    ...
    public record MediaDTO(int Id, string? Title, string? Description, double? AverageRating, DateOnly? ReleaseDate, int? Fsk, List<string> Genres, string? MediaType, string CreatorName);
