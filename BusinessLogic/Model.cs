...
namespace BusinessLogic.Models
{
    ...
    public record Media(int Id, string? Title, string? Description, DateOnly? ReleaseDate, int? Fsk, List<string> Genres, string? MediaType, double? AverageStars);
    ...
    public record PostRating(User User, Media Media, string? Comment, int? Stars);
