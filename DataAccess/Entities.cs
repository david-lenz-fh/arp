...
namespace DataAccess.Entities
{
    ...
    public record RatingEntity(int Id, string Username, int MediaId, string? Comment, int Stars);
    ...
    public record AddMedia(string Title, string? Description, DateOnly? ReleaseDate, int? Fsk, List<string> GenreNames, string? MediaType, string CreatorName);
