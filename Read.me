...
Bevor das Projekt gebuilded wird, müssen die docker_db_setup.bat (direkt im root verzeichnis) asusgeführt werden.
Alternativ kann auch vom root Verzeichnis 'docker compose -f "./DataAccess/db/docker-compose.yml" up -d mrp_db' ausgeführt werden.

Github Link: https://github.com/david-lenz-fh/arp
Postman Collection: Im root Verzeichnis "MRP.postman_collection.json"
